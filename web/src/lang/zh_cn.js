export default {
  ...
  tagManager: {
    title: '标签管理',
    currentMindMapTags: '当前思维导图标签',
    myTagLibrary: '我的标签库',
    addTag: '添加标签',
    createTag: '新建标签',
    refresh: '刷新',
    searchPlaceholder: '搜索标签...',
    noTags: '暂无标签，点击上方按钮创建标签',
    noTagsFound: '没有找到匹配的标签',
    selectMindMap: '请先选择或创建思维导图',
    batchOperation: '批量操作',
    batchAdd: '批量添加到当前思维导图',
    clearSelection: '清空选择',
    public: '公共',
    private: '私有',
    usageCount: '次使用',
    ...
    deleteTag: '删除标签',
    removeTag: '移除标签',
    confirmDelete: '确定要删除标签吗？删除后无法恢复。',
    confirmRemove: '确定要移除这个标签吗？',
    deleteSuccess: '标签删除成功',
    removeSuccess: '标签移除成功',
    addSuccess: '标签添加成功',
    alreadyExists: '该标签已在当前思维导图中',
    createDialog: {
      title: '创建标签',
      editTitle: '编辑标签',
      name: '标签名称',
      namePlaceholder: '请输入标签名称（最多50个字符）',
      color: '标签颜色',
      preview: '预览效果',
      previewText: '标签预览',
      usageStats: '使用统计',
      ...
      nameMaxLength: '标签名称不能超过50个字符',
      colorFormat: '请输入正确的颜色格式，如 #cccccc',
    ...
    selectionDialog: {
      ...
      clearAll: '清空',
      addTags: '添加标签',
      noSelection: '请选择要添加的标签',
      addSuccess: '成功添加标签',
      addFailed: '添加标签失败',
      alreadyInMindMap: '已在思维导图中',
      clickToAdd: '点击添加',
      pendingAdd: '待添加',
      createNewTag: '创建标签'
    }
  ...
  ai: {
    ...
    selectAIConfiguration: '选择AI服务',
    manageAIConfiguration: '管理AI配置',
    AIProviderConfiguration: 'AI提供商配置',
