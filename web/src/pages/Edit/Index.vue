  ...
  export default {
    ...
    methods: {
        ...
        try {
          ...
          if (toolbarStatus !== null) {
            ...
            if (typeof status === 'boolean') {
              ...
              const result = {
                current_state:
                  status.current_state !== undefined
                    ? status.current_state
                    : true,
                user_state:
                  status.user_state !== undefined ? status.user_state : true
              }
              return result
            }
          }
      ...
      isCurrentlyInMindmapManager() {
        ...
        if (tagMindmapPage) {
          const isVisible =
            window.getComputedStyle(tagMindmapPage).display !== 'none'
          return isVisible
        }
      ...
      setupRouteWatcher() {
        ...
        // 监听从思维导图管理页面返回的事件
        this.$bus.$on(
          'backFromMindmapManager',
          this.handleBackFromMindmapManager
        )
