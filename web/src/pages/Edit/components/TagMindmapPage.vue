  ...
  <div class="tagMindmapPage" :class="{ isDark: isDark }">
    ...
    <div class="page-header">
      <div class="header-left">
        <el-button type="text" icon="el-icon-arrow-left" @click="backToEditor" class="back-btn">
          返回编辑器
        </el-button>
      ...
      <div class="header-right">
        <div class="search-container">
          <el-input v-model="globalSearchKeyword" placeholder="搜索思维导图..." prefix-icon="el-icon-search" clearable
            class="global-search" @input="handleGlobalSearch"></el-input>
        </div>
    ...
    <div class="page-content">
      ...
      <div class="left-panel">
        <TagTreePanel ref="tagTreePanel" :user-tags="userTags" :selected-tag-ids="selectedTagIds"
          :mindmap-tag-mapping="mindMapTagMapping" :local-mindmaps="localMindMaps" @tag-select="handleTagSelect"
          @tag-create="handleTagCreate" @tag-edit="handleTagEdit" @tag-delete="handleTagDelete"
          @mindmap-add-tag="handleMindmapAddTag" @refresh-tags="refreshTagData" />
      </div>

      <!-- 右侧思维导图卡片区域 -->
      <div class="right-panel">
        <MindmapCards :mindmaps="filteredMindMaps" :user-tags="userTags" :mindmap-tag-mapping="mindMapTagMapping"
          :selected-mindmap-ids="selectedMindmapIds" :loading="isLoading" :search-keyword="globalSearchKeyword"
          @mindmap-select="handleMindmapSelect" @mindmap-load="handleMindmapLoad" @mindmap-delete="handleMindmapDelete"
          @mindmap-rename="handleMindmapRename" @mindmap-tag-update="handleMindmapTagUpdate"
          @batch-operation="handleBatchOperation" @tag-data-changed="handleTagDataChanged" />
      </div>
    </div>
  ...
  methods: {
    ...
    registerMindmapManagerShortcuts() {
      const highPriorityHandler = (event) => {
        ...
        // 检测Alt+C组合键
        if (this.altKeyPressed && (event.key.toLowerCase() === 'c' || event.code === 'KeyC')) {
    ...
    unregisterMindmapManagerShortcuts() {
      ...
      if (this.highPriorityHandler) {
        document.removeEventListener('keydown', this.highPriorityHandler, true)
