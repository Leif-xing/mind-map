<template>
  <div class="leftSidebarTrigger" :class="{ isDark: isDark }">
    ...
    <transition name="slide-right">
      <div v-show="isVisible" class="sidebar-container">
        ...
        <div class="sidebar-content">
          <!-- 思维导图按钮 -->
          <div class="nav-item" @click="openMindmapManager" :class="{ active: currentPage === 'mindmap-manager' }">
            <i>📑</i><span>思维导图</span>
          </div>

          <!-- 关于按钮 -->
          <div class="nav-item" @click="openAbout" :class="{ active: currentPage === 'about' }">
            <i>ℹ️</i><span>关于</span>
          </div>
    ...
    <!-- 可拖拽的修改密码对话框 -->
    <draggable-password-dialog :visible.sync="showPasswordDialog" @cancel="handlePasswordDialogCancel"
      @success="handlePasswordDialogSuccess"></draggable-password-dialog>
  </div>
</template>
