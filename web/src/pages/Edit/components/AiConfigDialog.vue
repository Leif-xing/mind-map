              ...
              providers: {
                ...
                [curKey]: {
                  ...
                  name:
                    ...
                    provider.name ||
                    this.ruleForm.providerName, // 更新供应商名称
                  ...
                  config: {
                    ...
                    port:
                      this.ruleForm.port ||
                      (provider.config && provider.config.port) ||
                      '',
                    method:
                      this.ruleForm.method ||
                      (provider.config && provider.config.method) ||
                      'POST'
                  }
                }
              }
        ...
        if (!dialogEl) {
          ...
          for (let dialog of allDialogs) {
            ...
            if (title) {
              ...
              if (
                titleText.includes('AI配置') ||
                titleText.includes('AIConfiguration') ||
                titleText.includes('AI Configuration')
              ) {
                dialogEl = dialog
