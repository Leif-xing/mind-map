...
export const setMindMapCache = (mindMapId, data) => mindMapCacheManager.set(mindMapId, data);
export const removeMindMapCache = (mindMapId) => mindMapCacheManager.delete(mindMapId);
